  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-4 md:top-5 left-1/2 transform -translate-x-1/2  h-[60px] md:h-[74px] z-30 transition-all duration-300  backdrop-blur-sm ${
          isScrolled ? "bg-[rgba(255,255,255,0.5)] w-[95%] max-w-[1600px] rounded-[20px] shadow-md" : "bg-teal-400 w-full"
        }`}
      >
