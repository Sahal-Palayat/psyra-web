...
import { CarouselHeaderHindi } from "./carousel-header-hindi";
// import { CarouselHeader } from "@/components/Psychologist/SimpleCarousel/carousel-header";
...
export default function PsychologistCarouselHindi() {
  ...
  return (
    <section id="psychologists" className="bg-[#F7F8F2]">
