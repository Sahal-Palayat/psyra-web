    ...
    <main className="min-h-screen  pb-16">
      ...
      <section className="px-4 m-2 pt-24 md:pt-32 pb-10 bg-[#B1DFAE] rounded-lg">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <button
            onClick={openModal}
            className="mt-1 inline-flex items-center justify-center rounded-full bg-teal-700 text-white text-sm md:text-base font-semibold px-8 md:px-18 py-2.5 shadow-md hover:bg-teal-800 transition-all"
          >
            Book Now
          </button>
        </div>
