...
export function BookingModal({ isOpen, onClose, packageTitle }: BookingModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[800px] md:max-w-[900px] p-0 overflow-hidden bg-white rounded-2xl">
        {isSuccess ? (
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600">
              Thank you {formData.name} for booking a consultation. We'll send the details to {formData.email} shortly.
            </p>
          </motion.div>
        ) : (
          <>
            <DialogHeader className="bg-[#005657] text-white p-6">
              <DialogTitle className="text-xl font-bold">Book Consultation</DialogTitle>
                            ...
                            {availableSlots.map((slot) => (
                              <Button
                                ...
                                className={`flex items-center justify-center ${
                                  timeSlot === slot ? "bg-[#005657] text-white" : "border-[#B6E5DF] text-[#005657]"
                                }`}
            ...
            <DialogFooter className="p-6 pt-0 flex flex-col sm:flex-row gap-2 border-t border-gray-100">
              {step === 1 ? (
                <>
