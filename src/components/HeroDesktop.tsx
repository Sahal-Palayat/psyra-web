    ...
    <>
      <section className="relative bg-teal-600 mb-10 text-white flex items-center">
        ...
        >
          ...
          >
            <div className="rounded-2xl bg-white/95 text-teal-900 shadow-xl px-5 md:px-8 py-5 md:py-7 border border-white/60 backdrop-blur-sm md:flex md:items-center md:gap-8 lg:gap-10">
              ...
              {/* Right: Copy + CTA */}
              <div className="w-full md:w-3/5 text-left md:text-left mt-2 md:mt-0">
                ...
                <motion.span
                  ...
                  className="inline-flex items-center gap-1 px-4 py-1 rounded-full bg-gradient-to-r from-teal-50 via-white to-emerald-50 text-teal-800 border border-teal-200/80 text-[11px] tracking-[0.18em] uppercase mb-3 shadow-sm"
                >
                ...
                <p className="text-sm md:text-base text-teal-900/90 mb-3 max-w-xl">
                  Give your mind a gentle reset for the year ahead. Release what feels heavy
                  and make space for calmer, clearer days.
                </p>
                <p className="text-xs md:text-sm text-teal-800/80 mb-4 max-w-xl">
                  A guided New Year journey with therapists to help you realign your thoughts,
