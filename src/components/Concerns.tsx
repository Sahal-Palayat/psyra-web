...
const DepressionIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#3B82F6" opacity="0.1" stroke="#3B82F6" strokeWidth="2" />
    <circle cx="35" cy="40" r="5" fill="#3B82F6" />
    <circle cx="65" cy="40" r="5" fill="#3B82F6" />
    <path d="M 35 65 Q 50 55 65 65" stroke="#3B82F6" strokeWidth="3" fill="none" strokeLinecap="round" />
  </svg>
)

const PanicIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#EF4444" opacity="0.1" stroke="#EF4444" strokeWidth="2" />
    <circle cx="50" cy="50" r="30" fill="none" stroke="#EF4444" strokeWidth="2" />
    <circle cx="50" cy="50" r="20" fill="none" stroke="#EF4444" strokeWidth="2" />
...
const PersonalityIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#6366F1" opacity="0.1" stroke="#6366F1" strokeWidth="2" />
    <circle cx="50" cy="35" r="12" fill="#6366F1" />
    <path d="M 35 50 Q 35 60 50 65 Q 65 60 65 50" fill="#6366F1" />
    <path d="M 30 70 L 70 70" stroke="#6366F1" strokeWidth="2" strokeLinecap="round" />
  </svg>
)
...
const AnxietyIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    ...
    <path d="M 50 30 L 55 45 L 70 45 L 58 55 L 63 70 L 50 60 L 37 70 L 42 55 L 30 45 L 45 45 Z" fill="#F97316" />
  </svg>
)

const StressIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#06B6D4" opacity="0.1" stroke="#06B6D4" strokeWidth="2" />
    <path
...
const SexualIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#EC4899" opacity="0.1" stroke="#EC4899" strokeWidth="2" />
    <circle cx="40" cy="45" r="8" fill="#EC4899" />
    <path d="M 40 53 L 40 65 M 35 58 L 45 58" stroke="#EC4899" strokeWidth="2" strokeLinecap="round" />
    <circle cx="60" cy="50" r="10" fill="none" stroke="#EC4899" strokeWidth="2" />
  </svg>
)

const RelationshipIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#22C55E" opacity="0.1" stroke="#22C55E" strokeWidth="2" />
...
const WorkIcon = () => (
  <svg viewBox="0 0 100 100" className="w-16 h-16">
    <circle cx="50" cy="50" r="45" fill="#FBBF24" opacity="0.1" stroke="#FBBF24" strokeWidth="2" />
    <rect x="30" y="35" width="40" height="35" rx="3" fill="none" stroke="#FBBF24" strokeWidth="2" />
    <path
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-2 text-lg max-w-2xl mx-auto">
              We provide compassionate support for a wide range of mental health concerns
            </p>
          </div>
